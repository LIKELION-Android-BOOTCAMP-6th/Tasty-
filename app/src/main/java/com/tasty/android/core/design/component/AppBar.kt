...
@Composable
fun TastyListItemButton(tastyItem: Unit) { // 테이스티 리스트 객체
...
// 테이스티 리스트 미리보기 함수
@Preview(showBackground = true, name = "테이스티 리스트 미리보기", device = Devices.PIXEL_7)
@Composable
        ...
        Column(
            ...
            AsyncImage(
                model = ImageRequest.Builder(LocalContext.current)
                    .data("https://cdn.travie.com/news/photo/first/201710/img_19975_1.jpg") // imageUrl
                    .crossfade(true)
                    .build(),
                contentDescription = ""
            )
